...
static const CMD StdCmdTable[] =
{
	...
	{ "ATBD", AT_BD, offsetof( device_t, serintCMD_bd ), READ | WRITE       ,  U8__SIZE, 0x01,       0x05, SET_serintCMD_bd, max_u32val      }, // B
	...
	{ "ATCT", AT_CT, offsetof( device_t, atcopCMD_ct  ), READ | WRITE       ,  U16_SIZE, 0x10,     0x1770, SET_atCT_tmp    , max_u32val      },
