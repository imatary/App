 ...
 */
 void SET_allDefault()
 {
	 ...
	 SET_atCT_tmp(CT_AT_CMD_TIMEOUT);
 ...
 */
void SET_netCMD_ni   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_ni   , val, len); }
void SET_secCMD_ky   (void *val, uint8_t len) { memcpy(RFmodul.secCMD_ky   , val, len); }
void SET_serintCMD_ro(void *val, uint8_t len) { memcpy(RFmodul.serintCMD_ro, val, len); }
void SET_atcopCMD_cc (void *val, uint8_t len) { memcpy(RFmodul.atcopCMD_cc , val, len); }
void SET_iolpCMD_ia  (void *val, uint8_t len) { memcpy(RFmodul.iolpCMD_ia  , val, len); }
void SET_netCMD_id   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_id   , val, len); }
void SET_netCMD_my   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_my   , val, len); }
void SET_netCMD_nt   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_nt   , val, len); }
void SET_netCMD_sc   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_sc   , val, len); }
void SET_netCMD_dh   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_dh   , val, len); }
void SET_netCMD_dl   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_dl   , val, len); }
void SET_ioserCMD_ir (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_ir , val, len); }
void SET_ioserCMD_pr (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_pr , val, len); }
void SET_ioserCMD_it (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_it , val, len); }
void SET_ioserCMD_ic (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_ic , val, len); }
void SET_ioserCMD_pt (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_pt , val, len); }
void SET_ioserCMD_rp (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_rp , val, len); }
void SET_iolpCMD_T0  (void *val, uint8_t len) { memcpy(RFmodul.iolpCMD_T0  , val, len); }
void SET_iolpCMD_T1  (void *val, uint8_t len) { memcpy(RFmodul.iolpCMD_T1  , val, len); }
void SET_iolpCMD_T2  (void *val, uint8_t len) { memcpy(RFmodul.iolpCMD_T2  , val, len); }
void SET_iolpCMD_T3  (void *val, uint8_t len) { memcpy(RFmodul.iolpCMD_T3  , val, len); }
void SET_iolpCMD_T4  (void *val, uint8_t len) { memcpy(RFmodul.iolpCMD_T4  , val, len); }
void SET_iolpCMD_T5  (void *val, uint8_t len) { memcpy(RFmodul.iolpCMD_T5  , val, len); }
void SET_iolpCMD_T6  (void *val, uint8_t len) { memcpy(RFmodul.iolpCMD_T6  , val, len); }
void SET_iolpCMD_T7  (void *val, uint8_t len) { memcpy(RFmodul.iolpCMD_T7  , val, len); }
void SET_diagCMD_vr  (void *val, uint8_t len) { memcpy(RFmodul.diagCMD_vr  , val, len); }
void SET_diagCMD_hv  (void *val, uint8_t len) { memcpy(RFmodul.diagCMD_hv  , val, len); }
void SET_sleepmCMD_st(void *val, uint8_t len) { memcpy(RFmodul.sleepmCMD_st, val, len); }
void SET_sleepmCMD_sp(void *val, uint8_t len) { memcpy(RFmodul.sleepmCMD_sp, val, len); }
void SET_sleepmCMD_dp(void *val, uint8_t len) { memcpy(RFmodul.sleepmCMD_dp, val, len); }
void SET_atcopCMD_gt (void *val, uint8_t len) { memcpy(RFmodul.atcopCMD_gt , val, len); }
void SET_rfiCMD_ca   (void *val, uint8_t len) { memcpy(RFmodul.rfiCMD_ca   , val, len); }
void SET_netCMD_ch   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_ch   , val, len); }
void SET_netCMD_ai   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_ai   , val, len); }
void SET_netCMD_a1   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_a1   , val, len); }
void SET_netCMD_a2   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_a2   , val, len); }
void SET_netCMD_mm   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_mm   , val, len); }
void SET_ioserCMD_d8 (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_d8 , val, len); }
void SET_ioserCMD_d7 (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_d7 , val, len); }
void SET_ioserCMD_d6 (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_d6 , val, len); }
void SET_ioserCMD_d5 (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_d5 , val, len); }
void SET_ioserCMD_d4 (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_d4 , val, len); }
void SET_ioserCMD_d3 (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_d3 , val, len); }
void SET_ioserCMD_d2 (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_d2 , val, len); }
void SET_ioserCMD_d1 (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_d1 , val, len); }
void SET_ioserCMD_d0 (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_d0 , val, len); }
void SET_serintCMD_bd(void *val, uint8_t len) { memcpy(RFmodul.serintCMD_bd, val, len); }
void SET_serintCMD_nb(void *val, uint8_t len) { memcpy(RFmodul.serintCMD_nb, val, len); }
void SET_sleepmCMD_so(void *val, uint8_t len) { memcpy(RFmodul.sleepmCMD_so, val, len); }
void SET_sleepmCMD_sm(void *val, uint8_t len) { memcpy(RFmodul.sleepmCMD_sm, val, len); }
void SET_rfiCMD_pl   (void *val, uint8_t len) { memcpy(RFmodul.rfiCMD_pl   , val, len); }
void SET_netCMD_sd   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_sd   , val, len); }
void SET_netCMD_rr   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_rr   , val, len); }
void SET_netCMD_rn   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_rn   , val, len); }
void SET_ioserCMD_p0 (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_p0 , val, len); }
void SET_ioserCMD_p1 (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_p1 , val, len); }
void SET_ioserCMD_iu (void *val, uint8_t len) { memcpy(RFmodul.ioserCMD_iu , val, len); }
void SET_netCMD_ce   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_ce   , val, len); }
void SET_netCMD_no   (void *val, uint8_t len) { memcpy(RFmodul.netCMD_no   , val, len); }
void SET_secCMD_ee   (void *val, uint8_t len) { memcpy(RFmodul.secCMD_ee   , val, len); }
void SET_diagCMD_dd  (void *val, uint8_t len) { memcpy(RFmodul.diagCMD_dd  , val, len); } 

void SET_serintCMD_ap(void *val, uint8_t len) { memcpy(RFmodul.serintCMD_ap, val, len); }
void SET_atcopCMD_ct (void *val, uint8_t len) { memcpy(RFmodul.atcopCMD_ct , val, len); }
